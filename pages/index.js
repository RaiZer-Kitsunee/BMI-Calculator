  ...
  return (
    <div className="w-screen h-screen bg-white">
      ...
      <section className="relative w-full h-full items-center gap-30 px-30 py-25 flex z-10">
        ...
        <div className="absolute w-[73%] h-[90%] bg-gradient-to-r from-white to-blue-200 z-0 top-0 left-0 rounded-br-2xl"></div>

        {/* left part description */}
        <div className="flex flex-col justify-center flex-1/2 gap-4 z-40">
          {/* main text */}
          <h1 className="font-bold text-[2.5rem] pr-30 leading-12 text-[#243349]">
            Body Mass Index Calculator
          </h1>

          {/* sub text */}
          <p className="font-semibold text-[0.8rem] pr-15 text-[#64707a]">
